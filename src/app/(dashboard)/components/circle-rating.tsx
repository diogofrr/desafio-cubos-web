      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="font-special font-semibold">
            <span
              className={`${size < 100 ? 'text-xl' : 'text-2xl'} uppercase tracking-normal leading-none`}
              style={{ color: ratingColor }}
            >
              {rating}
            </span>
            <span className="text-sm text-mauve-dark-12 uppercase tracking-normal leading-none">
              %
            </span>
          </span>
        </div>
