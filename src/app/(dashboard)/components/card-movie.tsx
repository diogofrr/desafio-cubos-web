  ...
  return (
    <Link href={`/movie/${id}`}>
      <div
        ...
        title={title}
      >
        <div className="absolute inset-0 shadow-[0_2px_8px_rgba(0,0,0,0.1)] group-hover:shadow-[0_8px_16px_rgba(0,0,0,0.2)] transition-shadow duration-300 ease-out"></div>
