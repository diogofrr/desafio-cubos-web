...
const Button = ({
  ...
  return (
    <button
      className={`${variants[variant]} ${className} text-current stroke-current`}
      {...props}
    >
      {children}
    </button>
